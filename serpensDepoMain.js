...
function appName() {get("boxTwo").innerHTML = "depoDepot";}
...
function resetVerb(){
	...
	sum = [["sum","I have "], ["es","You have "], ["est", thirdPerSing[ran3PSIndex]], ["sumus","We have "], ["estis","Ya'll have "], ["sunt", "They have "]];

	eram = [["eram","I had "], ["eras","You had "], ["erat", thirdPerSing[ran3PSIndex] + " had"], ["eramus","We had "], ["eratis","Ya'll had "], ["erant", "They had "]];

	ero = [["ero","I will have "], ["eris","You will have "], ["erit", thirdPerSing[ran3PSIndex] + " will have "], ["erimus","We will have "], ["eritis","Ya'll will have "], ["erunt", "They will have "]];


	verbsFirst = [["mir", "wonder"],  ["con", "try"],["hort", "urge"],["f", "speak"],["mor", "stay"], ["prec", "pray"]];

	//verbsSecond = [["vidē", "seen"], ["terrē", "frightened"], ["tenē", "held"], ["monē", "warned"],["timē", "feared"],["habē", "held"]];


	perEndingsFirst = [["or", "I "], ["āris", "You "], ["atur", thirdPerSing[ran3PSIndex] + " does "], ["āmur", "We "], ["āmini", "Ya'll "], ["antur", "They "]];

	perEndingsFirstImp = [["ābar", "I used to "], ["ābaris", "You used to "], ["ābatur", thirdPerSing[ran3PSIndex] + " used to "], ["ābamur", "We used to "], ["ābamini", "Ya'll used to "], ["ābantur", "They used to "]];

	perEndingsFuture = [["ābor", "I will "], ["āberis", "You will "], ["ābitur", thirdPerSing[ran3PSIndex] + " will "], ["abimur", "We will "], ["ābimini", "Ya'll will "], ["ābuntur", "They will "]];
	...
	verbsFirstPerPass = [["miratus", "mirata","amatum","amati"," wondered"],  ["conatus", "conata","conatum","conatae"," tried"],["hortatus", "hortata","hortatum","hortati"," urged"],["fatus", "fata","fatum","fatae"," spoken"],["moratus", "morata","moratum", "morati"," delayed"], ["precatus", "precata", "precatum", "precatae"," prayed"]];
